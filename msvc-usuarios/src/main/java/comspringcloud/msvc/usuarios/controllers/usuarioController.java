package comspringcloud.msvc.usuarios.controllers;

import comspringcloud.msvc.usuarios.models.entity.Usuario;
import comspringcloud.msvc.usuarios.services.UsuarioService;
...
public class usuarioController {
    ...
    public ResponseEntity<?> editar(@Valid @RequestBody Usuario usuario, BindingResult result, @PathVariable Long id) {
        ...
        if (o.isPresent()) {
            ...
            if(!usuario.getEmail().isEmpty() && !usuario.getEmail().equalsIgnoreCase(usuarioDb.getEmail()) && service.porEmail3(usuario.getEmail())){
